...
with col2:
    st.image('https://cdn.dribbble.com/userupload/12500996/file/original-b458fe398ad67f4e9999c66ec856ff69.gif', use_column_width=True)
avs.add_vertical_space(10)


# Define a 3:2 column layout
col1, col2 = st.columns([3, 2])
with col2:
